...
<div class="flex justify-center alignItems-center" style="margin-top: 4rem;">
    <div class="flex alignItems-center">
        <svg width="400" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600" style="visibility: visible;">
            <g>
                <defs>
                ...
                <g id="planet" transform="matrix(1,-0.0028,0.0028,1,-0.3046,1.5903)" style="transform-origin: 0px 0px;">
                    <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="572.859" cy="108.803" r="90.788"></circle>

                    <circle id="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="548.891" cy="62.319" r="13.074" transform="matrix(1,0,0,1,0.241,0)" style="transform-origin: 0px 0px;"></circle>

                    <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="591.743" cy="158.918" r="7.989" transform="matrix(1,0,0,1,-0.241,0)" style="transform-origin: 0px 0px;"></circle>
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"></path>
                ...
                <g id="stars">
                    <g id="starsBig">
                        <g transform="matrix(0.9973,0.0735,-0.0735,0.9973,20.2132,-37.387)" style="transform-origin: 0px 0px;">
                        ...
                        <g transform="matrix(0.9963,-0.0859,0.0859,0.9963,-20.2155,14.1712)" style="transform-origin: 0px 0px;">
                        ...
                        <g transform="matrix(0.9888,0.1493,-0.1493,0.9888,24.9875,-46.1906)" style="transform-origin: 0px 0px;">
                        ...
                        <g transform="matrix(0.9907,-0.136,0.136,0.9907,-65.2787,31.8827)" style="transform-origin: 0px 0px;">
                    ...
                    <g id="starsSmall">
                        <g transform="matrix(0.598,0,0,0.598,173.7333,155.2423)" style="transform-origin: 0px 0px;">
                        ...
                        <g transform="matrix(0.304,0,0,0.3044,340.7299,211.4238)" style="transform-origin: 0px 0px;">
                    ...
                    <g id="circlesBig">
                        ...
                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="588.977" cy="255.978" r="7.952" transform="matrix(1,0,0,1,0,-0.16)" style="transform-origin: 0px 0px;"></circle>

                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="450.066" cy="320.259" r="7.952" transform="matrix(1,0,0,1,0,-0.16)" style="transform-origin: 0px 0px;"></circle>

                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="168.303" cy="353.753" r="7.952" transform="matrix(1,0,0,1,0,-0.16)" style="transform-origin: 0px 0px;"></circle>

                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="429.522" cy="201.185" r="7.952" transform="matrix(1,0,0,1,0,-0.16)" style="transform-origin: 0px 0px;"></circle>

                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="200.67" cy="176.313" r="7.952" transform="matrix(1,0,0,1,0,-0.16)" style="transform-origin: 0px 0px;"></circle>

                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="133.343" cy="477.014" r="7.952" transform="matrix(1,0,0,1,0,-0.16)" style="transform-origin: 0px 0px;"></circle>

                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="283.521" cy="568.033" r="7.952" transform="matrix(1,0,0,1,0,-0.16)" style="transform-origin: 0px 0px;"></circle>

                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="413.618" cy="482.387" r="7.952" transform="matrix(1,0,0,1,0,-0.16)" style="transform-origin: 0px 0px;"></circle>
                    </g>
                    <g id="circlesSmall">
                        <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651" transform="matrix(1,0,0,1,0,-0.321)" style="transform-origin: 0px 0px;"></circle>
                        <circle fill="#0E0620" cx="253.29" cy="229.24" r="2.651" transform="matrix(1,0,0,1,0,-0.321)" style="transform-origin: 0px 0px;"></circle>
                        <circle fill="#0E0620" cx="434.824" cy="263.931" r="2.651" transform="matrix(1,0,0,1,0,-0.321)" style="transform-origin: 0px 0px;"></circle>
                        <circle fill="#0E0620" cx="183.708" cy="544.176" r="2.651" transform="matrix(1,0,0,1,0,-0.321)" style="transform-origin: 0px 0px;"></circle>
                        <circle fill="#0E0620" cx="382.515" cy="530.923" r="2.651" transform="matrix(1,0,0,1,0,-0.321)" style="transform-origin: 0px 0px;"></circle>
                        <circle fill="#0E0620" cx="130.693" cy="305.608" r="2.651" transform="matrix(1,0,0,1,0,-0.321)" style="transform-origin: 0px 0px;"></circle>
                        <circle fill="#0E0620" cx="480.296" cy="477.014" r="2.651" transform="matrix(1,0,0,1,0,-0.321)" style="transform-origin: 0px 0px;"></circle>
                    </g>
                </g>
                <g id="spaceman" clip-path="url(cordClip)" transform="matrix(1,0.0014,-0.0014,1,0.3094,0.1132)" style="transform-origin: 0px 0px;">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"></path>
				...
				M330.868,261.338c-7.929,1.72-15.381,5.246-21.799,10.246" transform="matrix(1,0.0014,-0.0014,1,0.3659,-0.3927)" style="transform-origin: 0px 0px;"></path>
				...
				s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"></path>
					...
					278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				" transform="matrix(0.8665,-0.4992,0.4992,0.8665,-33.569,203.5601)" style="transform-origin: 0px 0px;"></polygon>
                        </g>
                    </g>
                </g>
            </g>
        ...
        <div class="flex-column gap-3">
            <h6 class="font-family-black text-6xl text-center">
                404
            </h6>
            <div class="flex-column">
                <h6 class="font-family-regular text-lg text-center">
                    Oops! Bir şeyler ters gitti. Aradığınız sayfa bulunamadı.
                </h6>
                <p class="font-family-regular text-base text-gray  text-center">
                    Sayfa kaldırılmış veya değiştirilmiş olabilir. Başka bir şey aramak ister misiniz?
                </p>
            </div>
            <div class="flex justify-center">
                <a href="index.php" class="font-family-semibold text-sm home-button pointer px-4 py-1_5 text-black-t">
                    Ana Sayfa
                </a>
            </div>
        </div>
